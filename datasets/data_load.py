...
def load_data():
   cur,conn=create_connection()
   titles_file = r"/Users/hxu/Desktop/de_projects/dbt/Code/datasets/titles.csv" # <- Replace with your path.
   titles_delimiter = "," # Replace if you're using a different delimiter.
   credits_file=r"/Users/hxu/Desktop/de_projects/dbt/Code/datasets/credits.csv"
   credits_delimiter=","
